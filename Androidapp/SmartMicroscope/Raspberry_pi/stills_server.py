...
class imageServer():
    ...
    def startStreaming(self):
        ...
        with picamera.PiCamera() as camera:
            ...
            while(True):
                ...
                if int(self.previewresolution[0]) < 2500:
                    camera.framerate = 40
                else:
                    camera.framerate = 10
                    camera.sensor_mode = 3
    ...
    def processstringinput(self, settingstring):
        ...
        if 'capture' in settingstring:
            ...
            self.captureImage = True
        elif 'res 1326' in settingstring:
            self.largeresolution = (1362, 1024)
            self.captureImage = True
        elif 'res 1014' in settingstring:
            self.largeresolution = (1014, 760)
            self.captureImage = True
