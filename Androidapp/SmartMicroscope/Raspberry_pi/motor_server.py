...
class MotorServer():
    ...
    def movemotorx(self, location):
        try:
            ...
            self.xmotor.motor_run(self.GpioPinsX,.001, abs(stepstomovex), self.positiveornegative(stepstomovex), False, "half", .01)
    ...
    def movemotory(self, location):
        try:
            ...
            self.ymotor.motor_run(self.GpioPinsY,.001, abs(stepstomovey), self.positiveornegative(stepstomovey), False, "half", .01)
    ...
    def movemotorz(self, location):
        try:
            ...
            self.zmotor.motor_run(self.GpioPinsZ,.001, abs(stepstomovez), self.positiveornegative(stepstomovez), False, "half", .01)
